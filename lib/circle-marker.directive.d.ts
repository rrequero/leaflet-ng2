...
import { CircleMarker, CircleMarkerOptions, Event, PopupEvent, TooltipEvent, PathOptions, FillRule, LineCapShape, LineJoinShape, LatLng, LatLngTuple, LatLngLiteral } from 'leaflet';
